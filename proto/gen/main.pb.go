...
const file_proto_main_proto_rawDesc = "" +
	...
	"\x03sum\x18\x01 \x01(\x05R\x03sum27\n" +
	"\tCalculate\x12*\n" +
	"\x03Add\x12\x10.main.AddRequest\x1a\x11.main.AddResponseB\x14Z\x12/proto/gen;mainipbb\x06proto3"
...
var file_proto_main_proto_depIdxs = []int32{
	...
	1, // 1: main.Calculate.Add:output_type -> main.AddResponse
